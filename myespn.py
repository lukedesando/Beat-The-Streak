        ...
        for row in rows:
            ...
            if p_matchup_inx is None:
                ...
                df = df.append(self._produce_df_row(day, p_anchors[1],
                                                    away_anchors,home_anchors))
        return df
    #XXX Here's Where I can modify to get the pitcher's team
    def _produce_df_row(self, day, p_anchor, t_anchor,pt_anchor=None):
        opponent = None
        for a in t_anchor:
        ...
        return pd.DataFrame(data=[[day, player_name, player_team, espn_id, opponent]],
                            columns=["Date", "Name", "team", "espn_id", "opponent"])
